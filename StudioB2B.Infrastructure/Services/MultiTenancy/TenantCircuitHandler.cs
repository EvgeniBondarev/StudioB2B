...
public class TenantCircuitHandler : CircuitHandler
{
    ...
    public TenantCircuitHandler(TenantProvider tenantProvider, MasterDbContext masterDb, IHttpContextAccessor httpContextAccessor,
                                ISubdomainResolver subdomainResolver, ILogger<TenantCircuitHandler> logger)
    {
