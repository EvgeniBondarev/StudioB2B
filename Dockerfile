...
# Database connection string (REQUIRED - pass at runtime)
# Example: -e ConnectionStrings__MasterDb="Server=mysql;Database=StudioB2B_Master;User=root;Password=secret;"
...
ENV Jwt__Secret="REMOVED_JWT_SECRET"
