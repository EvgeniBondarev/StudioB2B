...
public class OzonReviewInfoResponseDto
{
    ...
    [JsonPropertyName("dislikes_amount")]       public int                      DislikesAmount      { get; set; }
    [JsonPropertyName("id")]                    public string                   Id                  { get; set; } = string.Empty;
    [JsonPropertyName("is_rating_participant")] public bool                     IsRatingParticipant { get; set; }
    [JsonPropertyName("likes_amount")]          public int                      LikesAmount         { get; set; }
    [JsonPropertyName("order_status")]          public string                   OrderStatus         { get; set; } = string.Empty;
    [JsonPropertyName("photos")]                public List<OzonReviewPhotoDto> Photos              { get; set; } = new();
    ...
    [JsonPropertyName("videos")]                public List<OzonReviewVideoDto> Videos              { get; set; } = new();
